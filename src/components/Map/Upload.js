...
const Upload = ({ navigation }) => {
  ...
  const onClickHandler = (event) => {
    ...
    console.log(
      "post : ",
      preURL.preURL + "/post?x=" + currentLongitude + "&y=" + currentLaditude
    );
    axios
      .post(
        preURL.preURL + "/post?x=" + currentLongitude + "&y=" + currentLaditude,
    ...
    <>
      ...
      >
        ...
        <ScrollView>
          <View style={{ paddingLeft: "5%", paddingRight: "5%" }}>
            <View>
              ...
              >
                ...
                {"\n"}
                다운로드한 사진을 사용할 경우 잘못된 위치정보가 표시 될 수
                있습니다.{"\n"}
              ...
              <View style={styles.imgContainer}>
                ...
                <View style={styles.buttonContainer}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={ImagePicker}
                  >
                    <Text style={{ color: "black", fontsize: 10 }}>갤러리</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
          ...
          <View
            style={{ paddingLeft: "5%", paddingRight: "5%", marginTop: 30 }}
          >
            <Text style={{ fontSize: 15, fontWeight: "bold" }}>
              해시태그 (필수)
            </Text>
